...
export default function Multiplayer() {
    ...
    async function sendSettings() {
        const response = await fetch('http://localhost:9090/api/createLobby', {
            ...
            body: JSON.stringify({ lobbyId: lobbyId, maxPlayers: maxPlayers?.value })
        });
                        ...
                        <>
                            ...
                            <Select
                                ...
                                styles={{
                                    option: (base, state) => ({
                                        ...base,
                                        color: state.isSelected ? 'white' : '#1e293b', // dark blue-gray for normal, white for selected
                                    ...
                                    singleValue: (base) => ({
                                        ...base,
                                        color: '#1e293b', // dark blue-gray for selected value
                                    }),
                                    input: (base) => ({
                                        ...base,
                                    ...
                                    placeholder: (base) => ({
                                        ...base,
                                        color: '#1e293b', // placeholder text color
                                    }),
                                    container: (base) => ({
                                    ...base,
                                    width: 300, // or '300px'
                                ...
                                theme={(theme) => ({
                                    ...
                                    colors: {
                                        ...theme.colors,
                                        neutral80: '#1e293b', // main text color
                                        neutral90: '#1e293b', // fallback for some themes
                                        neutral60: '#1e293b', // for disabled text
                                        primary25: '#bfdbfe', // option hover background
                                        primary: '#3b82f6',   // selected option background
                                    },
                                })}
                            />
